    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-2 col-md-4">
          <h5 class="text-xl font-semibold mb-4">Download</h5>
          <ul class="list-unstyled">
            <li class="mb-2">
              <a href="#" class="text-gray-400 hover:text-white">iOS App</a>
            </li>
            <li class="mb-2">
              <a href="#" class="text-gray-400 hover:text-white">Android App</a>
            </li>
          </ul>
        </div>
      </div>
