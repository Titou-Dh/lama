        ...
        <div class="container-fluid py-4">
            ...
            <div class="banner p-5 mb-4">
                <div class="row align-items-center" style="position: relative; z-index: 1;">
                    <div class="col-lg-8">
                        <h1 class="text-white mb-3">Discover and experience extraordinary Events</h1>
                        ...
                        <div class="d-flex gap-3">
                            <button class="btn btn-white">Discover now</button>
                            <button class="btn btn-outline-white">Watch video</button>
                        </div>
                    </div>
                </div>
            </div>
